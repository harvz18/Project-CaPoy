...
export default function ProfileScreen() {
  ...
  const { actionLoading, currentUser, error, logout, ratings, users, setRole, updateProfile } = useApp();
        ...
        {currentUser?.role === "worker" ? (
          ...
          <SettingsCard title="Client Preferences">
            ...
            <View style={styles.settingRow}>
              ...
              <Pressable onPress={handleSwitchToWorker} style={styles.outlineButton}>
