    ...
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.workerPanel}>
          <WorkerRow name="Juan Dela Cruz" rating="4.9 (124 Jobs)" online />
          <WorkerRow name="Elena Reyes" rating="4.8 (89 Jobs)" />
          <WorkerRow name="Roberto Santos" rating="5.0 (215 Jobs)" online />
        </View>
...
const fallbackClientTasks: Task[] = [
  {
    id: "task-1",
    clientId: "client-1",
    title: "Inventory Stock Audit",
    description: "Audit retail inventory.",
    category: "Inventory",
  ...
  },
  {
    ...
    description: "Clean the storefront.",
    category: "Cleaning",
...
function HistoryRow({ icon, title, subtitle, amount }: { icon: string; title: string; subtitle: string; amount: string }) {
  return (
