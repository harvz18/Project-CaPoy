...
export default function LoginScreen() {
  ...
  const { login, register, usingFirebase } = useApp();
      ...
      >
              ...
              {otpVisible ? (
                <>
                  ...
                  <View style={screenStyles.section}>
                    ...
                    >
                      <Text style={screenStyles.secondaryButtonText}>Login</Text>
                    </Pressable>
                  </View>
                </>
              ) : null}
          ...
          {registerVisible ? (
            <View style={screenStyles.registerPanel}>
              ...
              <Pressable
                ...
                style={({ pressed }) => [screenStyles.primaryButton, pressed && screenStyles.pressed]}
              >
                <Text style={screenStyles.primaryButtonText}>Complete Registration</Text>
              </Pressable>
            </View>
          ) : null}
        </View>
        ...
        <View style={screenStyles.footer}>
          ...
          <Text style={screenStyles.modeText}>
            Data mode: {usingFirebase ? "Firebase configured" : "Prototype mock data"}
          </Text>
