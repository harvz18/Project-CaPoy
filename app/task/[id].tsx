...
const interestedWorker = {
  ...
  note: "Available today and near your barangay."
};
...
export default function TaskDetailsScreen() {
  ...
  const { currentUser, tasks, acceptTask, updateTaskStatus } = useApp();
              ...
              <Pressable
                ...
                onPress={() =>
                  router.push({
                    ...
                    params: { id: interestedWorker.id, taskId: task.id }
                  })
                }
                style={styles.workerIdentity}
              >
                <View style={styles.workerAvatar}>
                  <Text style={styles.workerAvatarText}>J</Text>
                </View>
                <View style={styles.flex}>
                  <Text style={styles.workerName}>{interestedWorker.name}</Text>
                  <Text style={styles.workerMeta}>* {interestedWorker.rating} • {interestedWorker.jobs}</Text>
                  <Text style={styles.workerNote}>{interestedWorker.note}</Text>
                </View>
              </Pressable>
              <View style={styles.skillRow}>
                {interestedWorker.skills.map((skill) => (
